    ...
    $scope.addToCart = function () {
        var cache = angular.isDefined(cache) ? cache: Messages.search("confirm_check_screen"),
            numberOfPicksConfirm = {
                "title" : "Estas segur@?",
                "template" : "Escogiste "+SelectedImagesFactory.getPrintItemsCount()+" imagen(es), pero podés escoger hasta "+SelectedImagesFactory.getProduct().prices.first_items.quantity+ " por el mismo precio.",
                "cancelText" : "Cancelar",
                "okText" : "Aceptar"
            },
