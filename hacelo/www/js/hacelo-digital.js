...
services.factory('DB', ['$q', 'DB_CONFIG', '$window', '$log', function ($q, DB_CONFIG, $window, $log) {
    ...
    Instagram.prototype = {
        ...
        init: function() {
            ...
            this.tab = w.open(encodeURI(this.url), '_blank', 'location=yes');
            this.bind_events();
        },
        ...
        convert_img_to_encode: function(id) {
            ...
            w.dataURL = canvas.toDataURL("image/png");
            $('<img src="' + w.dataURL + '"/>').appendTo(".images-hidden");
            return w.dataURL;
        },
    ...
    //window.Instagram = w.Instagram || Instagram;
 (function(){
